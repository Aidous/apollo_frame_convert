...
function(PROTOBUF_GENERATE_CPP SRCS HDRS)
  ...
  message(STATUS "COMPLIED_PROJ_NAME:" ${COMPLIED_PROJ_DIR})
...
#
#    set(DEVEL_GENERATED_DIR ${RELT_DIR})
...
#    message(STATUS "DEVEL_GENERATED_DIR:" ${DEVEL_GENERATED_DIR})
    ...
    execute_process(
      COMMAND ${PROTOBUF_COMPILER} --cpp_out=${RELT_DIR} ${_protobuf_include_path} ${ABS_FIL}
    )
    execute_process(
...
#      COMMAND cp ${GENERATED_SRC} ${DEVEL_GENERATED_DIR}/${FIL_WE}.pb.cc
#    )
  endforeach()
